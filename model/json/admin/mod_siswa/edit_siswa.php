...
<script>
    ...
    $(document).ready(function() {
        $('#form-datadiri').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_siswa/crud_siswa.php?pg=simpan',
                data: $(this).serialize(),
                beforeSend: function() {
...
<script>
    ...
    $(document).ready(function() {
        $('#form-dataayah').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_siswa/crud_siswa.php?pg=dataayah',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script>
    ...
    $(document).ready(function() {
        $('#form-dataibu').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_siswa/crud_siswa.php?pg=dataibu',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script>
    ...
    $(document).ready(function() {
        $('#form-datawali').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_siswa/crud_siswa.php?pg=datawali',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script>
    ...
    $('#form-berkas').on('submit', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'admin/mod_berkas/crud_berkas.php?pg=ubah',
