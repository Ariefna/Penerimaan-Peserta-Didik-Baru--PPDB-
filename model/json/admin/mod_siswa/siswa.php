...
<script>
    ...
    $('#form-import').on('submit', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'admin/mod_siswa/crud_siswa.php?pg=import',
...
<script>
    ...
    $('#form-tambah').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'admin/mod_siswa/crud_siswa.php?pg=tambah',
            data: $(this).serialize(),
            beforeSend: function() {
                $('form button').on("click", function(e) {
                    e.preventDefault();
    ...
    $('#table-1').on('click', '.hapus', function() {
        ...
        swal({
            ...
            if (result) {
                $.ajax({
                    url: 'admin/mod_siswa/crud_siswa.php?pg=hapus',
                    method: "POST",
                    data: 'id_siswa=' + id,
                    success: function(data) {
                        iziToast.error({
...
<script>
    $('#form-konfirmasi').submit(function(e) {
        ...
        swal({
            ...
            if (result) {
                $.ajax({
                    url: 'admin/mod_siswa/crud_siswa.php?pg=konfirmasi',
                    method: "POST",
                    data: $(this).serialize(),
                    success: function(data) {
                        iziToast.success({
