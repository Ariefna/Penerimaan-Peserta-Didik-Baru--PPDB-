...
<section class="section">
    ...
    <td>
        <div class="section-body">
            ...
            <h2 class="section-title">Pengaturan Aplikasi SIDADIK Online</h2>
            <p class="section-lead">
                Silahkan Sesuaikan Pengaturan SIDADIK Online Disini
            </p>
                    ...
                    <ul class="nav nav-tabs" id="myTab5" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="kepala-tab5" data-toggle="tab" href="#kepala5" role="tab" aria-controls="kepala" aria-selected="false">
                                <i class="fas fa-card"></i> Waktu SIDADIK</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent5">
                        <div class="tab-pane fade show active" id="home5" role="tabpanel" aria-labelledby="home-tab5">
                                                        ...
                                                        ?>
                                                            ...
                                                            <script>
                                                                $('#form-edit<?= $no ?>').submit(function(e) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: 'POST',
                                                                        url: 'admin/mod_biaya/crud_biaya.php?pg=ubah',
                                                                        data: $(this).serialize(),
                            ...
                            <script>
                                $('#form-tambah').submit(function(e) {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: 'admin/mod_biaya/crud_biaya.php?pg=tambah',
                                        data: $(this).serialize(),
                                        success: function(data) {
                                ...
                                $('#table-1').on('click', '.hapus', function() {
                                    ...
                                    swal({
                                        ...
                                        if (result) {
                                            $.ajax({
                                                url: 'admin/mod_biaya/crud_biaya.php?pg=hapus',
                                                method: "POST",
                                                data: 'id_biaya=' + id,
                                                success: function(data) {
                                                    iziToast.error({
                        ...
                        <script>
                            $('#infobayar').submit(function(e) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'admin/mod_setting/crud_setting.php?pg=infobayar',
                                    data: $(this).serialize(),
                                    success: function(data) {
                                        if (data == 'ok') {
                                            iziToast.success({
                        ...
                        <div class="tab-pane fade" id="kepala5" role="tabpanel" aria-labelledby="kepala-tab5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>INFO WAKTU SIDADIK</h4>
                                        </div>
                                        <form id="syarat">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Kapan SIDADIK Mulai Dibuka??</label>
    ...
    <script>
        $('#syarat').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_setting/crud_setting.php?pg=aktifSIDADIK',
                data: $(this).serialize(),
                success: function(data) {
                    if (data == 'ok') {
                        iziToast.success({
