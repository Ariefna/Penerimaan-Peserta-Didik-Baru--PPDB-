...
<form id="form-setting">
    <div class="card" id="settings-card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Logo SIDADIK</label>
                <div class="col-sm-6 col-md-9">

                    <div class="custom-file">
                        <input type="file" name="logo_SIDADIK" class="custom-file-input" id="site-logo_SIDADIK">
                        <label class="custom-file-label">Choose File</label>
                    </div>
                    <div class="form-text text-muted">The image must have a maximum size of 1MB</div>
                </div>
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <img src="../<?= $setting['logo_SIDADIK'] ?>" class="img-thumbnail" width="600">
                </div>
            </div>
            <div class="form-group row align-items-center">
            ...
            <div class="form-group row align-items-center">
                <label for="site-description" class="form-control-label col-sm-3 text-md-right">Text Klik Chat siswa</label>
                <div class="col-sm-6 col-md-9">
