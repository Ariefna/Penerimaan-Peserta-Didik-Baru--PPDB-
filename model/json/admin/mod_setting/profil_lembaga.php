                ...
                <div class="tab-content" id="myTabContent5">
                    ...
                    <script>
                        ...
                        $('#form-setting1').on('submit', function(e) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: 'admin/mod_setting/crud_setting.php?pg=profile',
                    ...
                    <script>
                        ...
                        $('#form-setting2').on('submit', function(e) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: 'admin/mod_setting/crud_setting.php?pg=alamat',
                                data: new FormData(this),
                                processData: false,
                                contentType: false,
                                cache: false,
                    ...
                    <script>
                        ...
                        $('#form-setting3').on('submit', function(e) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: 'admin/mod_setting/crud_setting.php?pg=kontak',
                                data: new FormData(this),
                                processData: false,
                                contentType: false,
                                cache: false,
                    ...
                    <script>
                        ...
                        $('#form-setting4').on('submit', function(e) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: 'admin/mod_setting/crud_setting.php?pg=kepala',
                                data: new FormData(this),
                                processData: false,
                                contentType: false,
                                cache: false,
