                                ...
                                ?>
                                    ...
                                    <script>
                                        $('#form-edit<?= $no ?>').submit(function(e) {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: 'admin/mod_pengumuman/crud_pengumuman.php?pg=ubah',
                                                data: $(this).serialize(),
...
<script>
    $('#form-tambah').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'admin/mod_pengumuman/crud_pengumuman.php?pg=tambah',
            data: $(this).serialize(),
            success: function(data) {
    ...
    $('#table-1').on('click', '.hapus', function() {
        ...
        swal({
            ...
            if (result) {
                $.ajax({
                    url: 'admin/mod_pengumuman/crud_pengumuman.php?pg=hapus',
                    method: "POST",
