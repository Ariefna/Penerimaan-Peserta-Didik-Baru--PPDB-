...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Kontak Pensiswaan</div>
        </div>
    </div>
    ...
    <td>
        <div class="section-body">
            ...
            <h2 class="section-title">Pengaturan Kontak Pensiswaan</h2>
                                ...
                                ?>
                                    ...
                                    <script>
                                        $('#form-edit<?= $no ?>').submit(function(e) {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: 'admin/mod_kontak/crud_kontak.php?pg=ubah',
                                                data: $(this).serialize(),
    ...
    <script>
        $('#form-tambah').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'admin/mod_kontak/crud_kontak.php?pg=tambah',
                data: $(this).serialize(),
                success: function(data) {
        ...
        $('#table-1').on('click', '.hapus', function() {
            ...
            swal({
                ...
                if (result) {
                    $.ajax({
                        url: 'admin/mod_kontak/crud_kontak.php?pg=hapus',
                        method: "POST",
                        data: 'id_kontak=' + id,
                        success: function(data) {
                            iziToast.error({
