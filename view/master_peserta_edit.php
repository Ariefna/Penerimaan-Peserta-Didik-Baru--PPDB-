            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="font-weight-bold text-primary"><? echo $judul; ?> Data Siswa</h6>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        $('#form-dataayah').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'model/json/admin/mod_siswa/crud_siswa.php?pg=dataayah',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script>
    ...
    $(document).ready(function() {
        $('#form-dataibu').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'model/json/admin/mod_siswa/crud_siswa.php?pg=dataibu',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script>
    ...
    $(document).ready(function() {
        $('#form-datawali').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'model/json/admin/mod_siswa/crud_siswa.php?pg=datawali',
                data: $(this).serialize(),
                beforeSend: function() {
                    $('#btnsimpan').prop('disabled', true);
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on("change", "#form_prov", function() {
            ...
            $.ajax({
                type: 'POST',
                url: "model/json/admin/mod_siswa/daerah_siswa.php",
                data: data,
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on("change", "#form_prov_ayah", function() {
            ...
            $.ajax({
                type: 'POST',
                url: "model/json/admin/mod_siswa/daerah_ayah.php",
                data: data,
                success: function(hasil) {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on("change", "#form_prov_ibu", function() {
            ...
            $.ajax({
                type: 'POST',
                url: "model/json/admin/mod_siswa/daerah_ibu.php",
                data: data,
                success: function(hasil) {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on("change", "#form_prov_wali", function() {
            ...
            $.ajax({
                type: 'POST',
                url: "model/json/admin/mod_siswa/daerah_wali.php",
                data: data,
                success: function(hasil) {
...
<script>
    ...
    $('#form-berkas').on('submit', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'model/json/admin/mod_berkas/crud_berkas.php?pg=ubah',
